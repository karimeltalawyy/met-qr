...
class StartSessions extends HookWidget {
   StartSessions({super.key});
   DateTime? fromDate;
   DateTime? toDate;
  @override
  Widget build(BuildContext context) {
    ...
    final TextEditingController lectureNameCtrl = TextEditingController();
  ...
  // }
  //
  // Future saveDateTime(context) async {
  //   final isValid = formKey.currentState!.validate();
  //   if (isValid) {
  //     final event = Event(
  //       title: lectureNameCtrl.text,
